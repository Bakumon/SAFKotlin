...
//        startActivityForResult(intent, OPEN_DIRECTORY_REQUEST_CODE)
        ...
        val request = DocumentTreeRequest(this)
        request.request {
            if (it == null) {
                Toast.makeText(baseContext, "denied", Toast.LENGTH_LONG).show()
            } else {
                Toast.makeText(baseContext, "granted:" + it.path, Toast.LENGTH_LONG).show()
            }
        }
    }
